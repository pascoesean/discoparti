...
This repository contains the code itself, as well as an example runthrough from two datasets from Type I Diabetes patients. DisCo ParTI recapitulates the known ablation of β cells in T1D patients and diseased cells are shown to preferentially resolve near known T1D associated gene signatures. Additionally, we find expression of REG family proteins to be preferentially associated with healthy controls in alpha cells, thus resolving fine-tuned molecular shifts along with broad correlates of disease. A web-visible version of the generated polytopes (`discoparti.html`) is available [here](https://raw.githack.com/pascoesean/discoparti/main/discoparti.html#phenotype-enrichment-analysis)
